...
public class StringTest {
    ...
    @DisplayName("JUnit 학습-String-요구사항1 (문자나누기_contains)")
    @Test
    void 문자나누기_테스트_1() {
    ...
    @DisplayName("JUnit 학습-String-요구사항1 (문자나누기_containsExactly)")
    @Test
    void 문자나누기_테스트_2() {
        String testString = "1";
        String[] splitResult = testString.split(",");
    ...
    @DisplayName("JUnit 학습-String-요구사항2 (문자자르기_isEqualTo")
    @Test
    void 문자자르기_테스트_요구2() {
        String testString = "(1,2)";
    ...
    @DisplayName("JUnit 학습-String-요구사항3 (문자추출_문자확인)")
    @Test
    void 문자추출_테스트_1() {
    ...
    @DisplayName("JUnit 학습-String-요구사항3 (문자추출_exception확인_방식1)")
    @Test
    void 문자추출_테스트_2_1() {
        String testString = "abc";
        int position = 3;
    ...
    @DisplayName("JUnit 학습-String-요구사항3 (문자추출_exception확인_방식2)")
    @Test
    void 문자추출_테스트_2_2() {
        String testString = "abc";
        int position = 4;
